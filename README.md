...
## 1) Clone the project
git clone https://github.com/AmitSaha93/nhs-mini-task-tracker.git
...
1) npm run start        # Run the app in development
2) npm run build    # Production build (in /build)
3) npm run test         # Run tests in watch mode
4) npm run test -- --coverage   # Run tests with coverage
